 ...
 */
public class Delete_Batch_Teacher extends javax.swing.JFrame {

    /**
     * Creates new form Delete_Batch_Teacher
     */
    public Delete_Batch_Teacher() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Delete Batch Teacher");
        ...
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, -1, -1));

        batch_teacher_id_input.setBorder(null);
        jPanel3.add(batch_teacher_id_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 380, 180, -1));
        ...
        jPanel3.add(Delete_Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 370, -1, -1));

        jSeparator2.setBackground(new java.awt.Color(51, 153, 255));
        jPanel3.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 400, 180, 10));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_Batch_Teacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_Batch_Teacher().setVisible(true);
            }
        });
    }

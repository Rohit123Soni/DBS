 ...
 */
public class ShowBatchTeacher extends javax.swing.JFrame {

    /**
     * Creates new form Show_Batch_Teacher
     */
    public ShowBatchTeacher() {
        initComponents();
        showBatch_teachers();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                    BATCHE'S RECORD");

        show_Batch_Teacher_Table.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 204, 255), 5));
        show_Batch_Teacher_Table.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowBatchTeacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowBatchTeacher().setVisible(true);
            }
        });
    }
     ...
     private void showBatch_teachers() {
        ...
        System.out.println("BATCH_TEACHER ID     TEACHER_ID      BATCH_ID");
